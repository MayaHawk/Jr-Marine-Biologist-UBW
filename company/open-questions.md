...
| **SH-28** | 🔴 **What are the age options in the dropdown, and is the field required?** This matters more than it sounds. **If the dropdown offers 4–6, you are already selling a tier whose cards are not finished** — the Age 4–6 set is still in the old design format and sits outside the ALL master *(SH-18, SH-24)*. It also settles the band naming: your words were **7–9**, `known-facts.md` records **7–10**, and whichever the store shows is what customers have already bought. | Product, Ops, Sales | ⬜ |
